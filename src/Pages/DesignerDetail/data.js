export const my_table = [
  {
    ...
    image: [
      {
        url: require("../../images/body/Images/11phong-cach-indochine-noi-that-vinmicjpg-1053.jpg")
      },
      {
        url: require("../../images/body/Images/12phong-cach-indochine-noi-that-vinmicjpg-1053.jpg")
      },
      {
        url: require("../../images/body/Images/Plan-and-elevation-of-bedroom-interior-2d-view-cad-block-layout-file-in-autocad-format-Thu-Sep-2018-05-22-23.webp")
      }
    ],
    data: [
      {
  ...
  },
  {
    ...
    image: [
      {
        url: require("../../images/body/Images/classic-bedroom-photos-by-leaf-design.jpg")
      },
      // {
      //   url: require("../../images/body/Images/25.jpeg")
      // },
      // {
      //   url: require("../../images/body/Images/26.jpeg")
      // }
    ],
    data: [
      {
  ...
  },
  {
    ...
    image: [
      {
        url: require("../../images/body/Images/modern-bedroom-photos-by-uk-design-studio-ki-n-truc-uk.jpg")
      },
      {
        url: require("../../images/body/Images/29.jpg")
      },
      {
        url: require("../../images/body/Images/30.jpg")
      }
    ],
    data: [
      {
  ...
  },
  {
    ...
    image: [
      {
        url: require("../../images/body/Images/modern-bedroom-photos-by-icon-interior.jpg")
      },
      {
        url: require("../../images/body/Images/32.jpg")
      },
      {
        url: require("../../images/body/Images/33.jpg")
      }
    ],
    data: [
      {
  ...
  },
  {
    ...
    image: [
      {
        url: require("../../images/body/Images/classic-living-room-photos-by-icon-interior.jpg")
      },
      {
        url: require("../../images/body/Images/35.jpg")
      },
      {
        url: require("../../images/body/Images/36.jpg")
      }
    ],
    data: [
      {
  ...
  },
  {
    ...
    image: [
      {
        url: require("../../images/body/Images/asian-living-room-photos-by-leaf-design.jpg")
      },
      {
        url: require("../../images/body/Images/38.jpg")
      },
      {
        url: require("../../images/body/Images/39.jpg")
      }
    ],
    data: [
      {
  ...
  },
  {
    ...
    image: [
      {
        url: require("../../images/body/Images/industrial-living-room-photos-by-cong-ty-c-ph-n-n-i-th-t-decox.jpg")
      },
      {
        url: require("../../images/body/Images/42.jpg")
      },
      {
        url: require("../../images/body/Images/4.jpg")
      }
    ],
    data: [
      {
  ...
  },
  {
    ...
    image: [
      {
        url: require("../../images/body/Images/tropical-kitchen-photos-by-ad.jpg")
      },
      {
        url: require("../../images/body/Images/tropical-kitchen-photos-by-ad (1).jpg")
      },
    ],
    data: [
      {
  ...
  },
  {
    ...
    image: [
      {
        url: require("../../images/body/Images/modern-kitchen-photos-by-artof3l.jpg")
      },
    ],
    data: [
      {
  ...
  },
  {
    ...
    image: [
      {
        url: require("../../images/body/Images/tropical-bathroom-photos-by-ad.jpg")
      },
      {
        url: require("../../images/body/Images/modern-bathroom-photos-by-cong-ty-trang-tri-n-i-th-t-rim-decor.jpg")
      },
    ],
    data: [
      {
  ...
  },
  {
    ...
    image: [
      {
        url: require("../../images/body/Images/tropical-bathroom-photos.jpg")
      },
      {
        url: require("../../images/body/Images/tropical-bathroom-photos(1).jpg")
      },
    ],
    data: [
      {
  ...
  },
  {
    ...
    image: [
      {
        url: require("../../images/body/Images/asian-kitchen-photos-by-leaf-design.jpg")
      },
    ],
    data: [
      {
  ...
  },
  {
    ...
    image: [
      {
        url: require("../../images/body/Images/13.jpg")
      },
      {
        url: require("../../images/body/Images/14.jpg")
      },
      {
        url: require("../../images/body/Images/15.jpg")
      }
    ],
    data: [
      {
